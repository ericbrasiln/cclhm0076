...
## "Índio": uma generalização que oculta diversidade {.center}

- Termo generalizante que não reflete a diversidade de povos e culturas da América
- Aceito apenas como oposição entre povos de origem europeia e "nativos" de culturas não-ocidentais
- Nunca constituíram um bloco monolítico: alianças e conflitos entre povos distintos são a regra

---

## Cultura ≠ Etnia {.center}

- Confundir "cultura" e "etnia" como critério de indianidade é um equívoco frequente
- Exige-se do indígena sinais diacríticos que marcariam sua diferença — como se não pudesse mudar
- Critérios de identificação étnica estão mais ligados às **relações sociais** do que a culturais

---

## O mito do "índio eterno" {.center}

- O indígena que usa roupas ocidentais, celular ou computador não deixa de ser indígena
- A cultura não se perde: **se transforma**
- Negar a historicidade dos povos indígenas é negar-lhes o direito à própria história
...
> SILVA, Kalina Vanderlei; SILVA, Maciel Henrique. **Índio**. In: *Dicionário de conceitos históricos*. São Paulo: Contexto, 2009. [Link](https://ericbrasil.com.br/cclhm0057_ihl/textos/mod_1/SILVA_SILVA.pdf)

**Complementar:**

> CAVALCANTE, T. L. V. **Etno-história e história indígena**. *História* (São Paulo), v. 30, n. 1, 2011. [Link](https://doi.org/10.1590/S0101-90742011000100017)
...
- CAVALCANTE, Thiago Leandro Vieira. Etno-história e história indígena: questões sobre conceitos, métodos e relevância da pesquisa. *História* (São Paulo), v. 30, n. 1, p. 155-189, 2011.
